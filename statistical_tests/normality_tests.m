% Normality test - 0 = normal, 1 = not normal - Performs Lilliefors, Anderson-Darling, Jarque-Bera, and Shapiro-Wilk tests
% normality_tests(x)
function normality_tests(x)
	
test_names = {'Lilliefors Test(lillietest)'; 'Anderson-Darling Test(adtest)'; 'Jarque-Bera Test(jbtest)'; 'Shapiro-Wilk test(swtest)'};
...
T = table(test_names, h_vals, p_vals, 'VariableNames', {'Test', 'h-value(0=Norm,1=~Norm)', 'p-value'});
